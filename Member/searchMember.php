...
<body class="bg-dark ">
        <div class="d-flex justify-content-end">
            ...
            <div class="p-3">
                <a href="menuMember.php"><button type="button"
                        ...
                        <table class=" table table-bordered text-center">
                            ...
                            <?php
                                ...
                                if($con -> connect_error){
                                    ...
                                    $sql = "SELECT * FROM member WHERE member_name LIKE '%$search%' ORDER BY $sort $order";

                                    //step 3: ask connection, to processs sql
                                    $result = $con -> query($sql);//object - a list of member record
                                    ...
                                    if($result->num_rows > 0){
                                        ...
                                        while($row = $result->fetch_object()){
                                            printf("<tr>
                                                    ...
                                                    <td>%s </td>
                                                    <td>%s </td>
                                                    <td><button class ='btn btn-warning'><a href='updateMember.php?id=%s' style='text-decoration:none;color:black;'>Edit</a></button></td>  
