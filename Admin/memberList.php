                                    ...
                                    <tr>
                                        <?php 
                                         ...
                                         ?>       
                                            ...
                                            <td><?php echo "<form action='../General/updateProfile.php' method='POST'><button class ='btn btn-warning' type='submit' name='id' value='$row[member_id]'>Edit</button></form>"?></td>
                                            <td><?php echo "<form action='../Admin/deleteCfm.php' method='POST'><button class ='btn btn-danger' type='submit' name='id' value='$row[member_id]'>Delete</button></form>"?></td>
